...
## Javascript Assignments  [![Build Status](https://travis-ci.com/Azizxon/js-assignments.svg?branch=master)](https://travis-ci.com/github/Azizxon/js-assignments)
...
* Run `git clone https://github.com/azizxon/js-assignments.git` from command line to download the repo.
...
```
* Open https://github.com/azizxon/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/azizxon/js-assignments/builds).
